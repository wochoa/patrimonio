        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body border-bottom p-1">
                    <h4 class="card-title">Administracion de estado</h4>
                </div>
                <div class="form-group row p-2">
                    <div class="col-sm-4">
                        <label for="">Ingrese la estado</label>
                        <input type="text" ref='focusMe' class="form-control form-control-sm digitacion" placeholder="Ingrese la estado aqui" v-model="nombreestado" autofocus>
                    </div>
                    
                    <div class="col-sm-4 mt-4">
                        <button class="btn btn-primary btn-sm" @click="agregarestado">
                            <i class="fa-regular fa-file"></i> Agregar estado</button>
                    </div>
                ...
                <div class="card-datatable table-responsive pt-0">
                    <table class="user-list-table table table-sm table-bordered table-hover">
                        ...
                        <tbody>
                            <tr v-for="mar in dataestado">
                                <td>{{mar.idestado}}</td>
                                <td>{{mar.des_estado}}</td>
